...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 10, 2025 at 03:19 PM
...
INSERT INTO `customer` (`cid`, `userId`, `totalAmount`, `payDate`) VALUES
(1, 101, 0.00, NULL),
(2, 105, 0.00, NULL);
...
INSERT INTO `enquiry` (`enquiryid`, `userId`, `type`, `message`, `status`) VALUES
...
INSERT INTO `rentalrequest` (`requestId`, `userId`, `regNo`, `dateRequested`, `dateFrom`, `dateTo`, `status`, `message`) VALUES
...
(101, 2, 'DFO-9638', '2025-03-10', '0018-04-17', '0018-04-20', 'Declined', NULL),
(102, 105, 'ALY-3962', '2025-03-10', '2025-03-11', '2025-03-16', 'Accepted', NULL),
(103, 105, 'ALY-3962', '2025-03-10', '2025-03-11', '2025-03-16', 'Pending', NULL),
(104, 105, 'ALY-3962', '2025-03-10', '2025-03-10', '2025-03-15', 'Pending', NULL),
(105, 2, 'UJP-1938', '2025-03-10', '2025-03-12', '2025-03-19', 'Pending', NULL);
...
INSERT INTO `staff` (`staffId`, `staffType`, `userId`) VALUES
(23, 'Admin', 2),
(24, 'Admin', 3),
(25, 'Admin', 1),
(26, 'Staff', 10),
...
INSERT INTO `user` (`userId`, `name`, `email`, `address`, `city`, `phone`, `pwd`, `active`) VALUES
(1, 'Ann Webb', 'awebb0@devhub.com', '670 Warner Way', 'Makamba', '903-39-4385', 'XWTKjz2', 'In-Active'),
(2, 'Andrew Mendoza', 'admin@admin.com', '26 Cambridge Hill', 'Roskoshnyy', '337-38-5945', '123456', 'Active'),
(3, 'Kathryn Wagner', 'kwagner2@mayoclinic.com', '34 Independence Lane', 'Osieczany', '581-88-8114', 'zlikt7Nsmru', 'Active'),
(4, 'Aaron Little', 'staff@staff.com', '4367 Blackbird Court', 'Arles', '692-59-0908', '123456', 'Active'),
...
(101, 'test test', 'Thanush@gmail.com', 'fdgfdg', 'sdfs', '0761201177', '12345678', 'active'),
(102, 'test test', 'rwerwe@rwer.wer', 'fdgfdg', 'sdfs', '0761201177', '123456', 'active'),
(103, 'Thanusan Thanushan', 'test12@gmail.com', 'vamash\r\nkondavil', 'jaffna', '0761201177', '123456', 'active'),
(104, 'test test', 'sdasd@gmail.com', 'fdgfdg', 'sdfs', '0761201177', '123456', 'active'),
(105, 'fsdfsdfsd', 'sdsd@sdf.ds', 'fdgfdg', 'sdfs', '0761201177', '123456', 'active');
...
--
ALTER TABLE `staff`
  ADD PRIMARY KEY (`staffId`,`userId`),
  ADD KEY `R_16` (`userId`);
...
--
ALTER TABLE `enquiry`
  MODIFY `enquiryid` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=201;

--
-- AUTO_INCREMENT for table `rentalrequest`
--
ALTER TABLE `rentalrequest`
  MODIFY `requestId` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `staff`
--
ALTER TABLE `staff`
  MODIFY `staffId` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;
...
--
ALTER TABLE `rentalrequest`
  ADD CONSTRAINT `R_13` FOREIGN KEY (`regNo`) REFERENCES `car` (`regNo`),
  ADD CONSTRAINT `R_5` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);

--
-- Constraints for table `staff`
--
ALTER TABLE `staff`
  ADD CONSTRAINT `R_16` FOREIGN KEY (`userId`) REFERENCES `user` (`userId`);
COMMIT;
